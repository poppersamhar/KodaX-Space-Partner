...
| ID   | Outcome                                                                                                                                               | Category          | Priority | Target         | Status     | SDK gate                                                                                                                                                                                         | Design                                                                                                                                          |
| ---- | ----------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- | -------- | -------------- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| F146 | Partner Plugin Library Extension: independently installable UI package, persistent experts, and session-scoped document connectors (Feishu CLI first) | New / Enhancement | High     | v0.1.61 (fork) | InProgress | Reuse public agentProfile and existing single-Skill invocation; bounded Feishu CLI adapter with governed remote proposals, existing MCP transport unchanged; no SDK fork or Skill-system rewrite | [F146 design](features/v0.1.61.md#feature_146-partner-plugin-library-extension), [development plan](features/v0.1.61-partner-plugin-library.md) |
