...
| `v0.1.62`         | —                                                                                                                     | none                              | —                                                                                                                                                                                                                                                                                                                                                                                         |
| `v0.1.63`         | —                                                                                                                     | none                              | —                                                                                                                                                                                                                                                                                                                                                                                         |
| `v0.1.64`         | Partner composer-first Skill workspace                                                                                | F130                              | Editable scene prompts above the composer, explicit or automatic installed-Skill invocation under unchanged permissions, compact Task materials/Collaboration/Artifacts cards, and on-demand Results/Process/Files with selected details and real Files/Browser/Terminal in the tabbed workspace.                                                                                          |
| `v0.1.65`         | —                                                                                                                     | none                              | —                                                                                                                                                                                                                                                                                                                                                                                         |
