...
| ID   | Outcome                                                                                                                                               | Category          | Priority | Target      | Status     | SDK gate                                                                                                                                                                                                                             | Design                                                                                                                                          |
| ---- | ----------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- | -------- | ----------- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| F146 | Partner Plugin Library Extension: independently installable UI package, persistent experts, and session-scoped document connectors (Feishu CLI first) | New / Enhancement | High     | v0.1.61-p.1 | InProgress | Reuse public agentProfile and existing single-Skill invocation; Partner direct-create uses trusted receipts plus an independent content-verification signal and a unified typed detail workspace; existing MCP transport unchanged; no SDK fork, KodaX Runtime change, Coder change, or Skill-system rewrite | [F146 Space design](features/v0.1.61.md#feature_146-partner-plugin-library-extension), [Partner PF001](partner/FEATURE_LIST.md#pf001--partner-plugin-library-extension), [development plan](partner/features/v0.1.61-partner-plugin-library.md) |
...
- Status: InProgress; fork-only target `v0.1.61-p.1`; Released: none.
...
- Partner mapping: [PF001](partner/FEATURE_LIST.md#pf001--partner-plugin-library-extension) owns the internal development and integration states; Partner `Completed` will not automatically complete F146.
- Space design: [FEATURE_146 block](features/v0.1.61.md#feature_146-partner-plugin-library-extension). Partner product requirements, P1–P9 phases, connector evidence, reviews and human acceptance are maintained under the [Partner documentation center](partner/README.md), with the canonical detailed plan at [Partner plugin plan](partner/features/v0.1.61-partner-plugin-library.md).
