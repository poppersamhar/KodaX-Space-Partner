...
| F130 | Partner Composer-First Skill Workspace: new-task scene shortcuts write editable prompts, real installed Skills work through explicit and Auto LLM activation, and on-demand Results/Pending review stay beside the conversation | Enhancement            | High     | `v0.1.64`           | InProgress  | Existing KodaX SkillRegistry, `skill` tool, `skillDynamicContext`, Partner AgentProfile/tool policy, and F095/F109/F114/F122-F124; no new SDK API and no permission expansion                                                                                                                                                                                                                                                        | [v0.1.64](features/v0.1.64.md#feature_130-partner-composer-first-skill-workspace)                                          |
...
| `v0.1.62`         | —                                                                                                                     | none                              | —                                                                                                                                                                                                                                                                                                                                                                                         |
| `v0.1.63`         | —                                                                                                                     | none                              | —                                                                                                                                                                                                                                                                                                                                                                                         |
| `v0.1.64`         | Partner composer-first Skill workspace                                                                                | F130                              | New tasks offer editable scene prompts above the composer; Partner can explicitly or automatically invoke installed Skills under unchanged permissions, with materials and Results/Pending review on demand.                                                                                                                                                                              |
| `v0.1.65`         | —                                                                                                                     | none                              | —                                                                                                                                                                                                                                                                                                                                                                                         |
