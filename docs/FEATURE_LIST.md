...
| ID   | Outcome                                                                                                                                               | Category          | Priority | Target                              | Status     | SDK gate                                                                                                                                                                                                                             | Design                                                                                                                                                                                                                                                                                                 |
| ---- | ----------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- | -------- | ----------------------------------- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| F146 | Partner Plugin Library Extension: independently installable UI package, persistent experts, and session-scoped document connectors (Feishu CLI first) | New / Enhancement | High     | Partner `v0.1.0`; Space release TBD | InProgress | Reuse public agentProfile and existing single-Skill invocation; Partner direct-create uses trusted receipts plus an independent content-verification signal and a unified typed detail workspace; existing MCP transport unchanged; no SDK fork, KodaX Runtime change, Coder change, or Skill-system rewrite | [F146 Space design](features/v0.1.61.md#feature_146-partner-plugin-library-extension), Partner [PF001](partner/features/v0.1.0.md#feature-pf001), [PF002](partner/features/v0.1.0.md#feature-pf002), and [PF003](partner/features/v0.1.0.md#feature-pf003), [Partner `v0.1.0` design](partner/features/v0.1.0.md) |
...
<a id="f146--partner-plugin-library-extension"></a>

### F146 — Partner Plugin Library Extension

- Status: InProgress; Partner product target `v0.1.0`; Space release target: TBD; compatibility baseline: `v0.1.46-alpha.5`; Released: none.
- Space scope: track whether the Partner plugin-library capability is accepted into Space without marking F096, F102, F130, canonical `v0.1.61`, KodaX Runtime or Coder complete or changed.
- Partner mapping: [PF001](partner/features/v0.1.0.md#feature-pf001) owns the Extension and expert library, [PF002](partner/features/v0.1.0.md#feature-pf002) owns governed connector previews and the Feishu platform expert, and [PF003](partner/features/v0.1.0.md#feature-pf003) owns receipt-first delivery and the unified workspace. Their development and integration states remain Partner-owned; Partner `Completed` will not automatically complete F146.
- Space design: [FEATURE_146 block](features/v0.1.61.md#feature_146-partner-plugin-library-extension). That block remains in the Space version-design file as an integration record; it does not assign Partner `v0.1.0` to Space `v0.1.61`. Partner requirements, connector evidence, reviews and human acceptance are maintained under the [Partner documentation center](partner/README.md), with the active product design at [Partner `v0.1.0`](partner/features/v0.1.0.md).
- Confirmed boundary: the Skill library, KodaX substrate and Coder remain shared/unchanged; OAuth, CLI, credentials, resource scope and real remote operations remain controlled by the Space trusted host. Integration evidence and upstream differences are tracked in [Partner Integration](partner/INTEGRATION.md).
